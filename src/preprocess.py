...
def Save_imgs(imgs,path_name):
    #前処理の種類ごとにディレクトリを作成
    root=config.data_root
    dir_path = '../medicaldata/images/CASIA2_16/' + path_name
...
if __name__ == '__main__':
    ...
    img_paths = make_img_paths() #'../medicaldata/images/CASIA2_16/*_000.jpg'
    imgs = make_imgs(img_paths)

    #画像の中で今日更新したものに限ってトリミング処理
    #modified_img_paths = glob('../medicaldata/images/CASIA2_16/*_000.jpg')
    #for path in modified_img_paths:
    #    t = os.path.getmtime(path)
    #    d = datetime.datetime.fromtimestamp(t)
    #    dt_now = datetime.datetime.now()

    #    if d.year == dt_now.year and d.month == dt_now.month and d.day == dt_now.day:
